    ...
    function($scope, $http, ngDialog, r_checkers, $stateParams) {
                ...
                ngDialog.open({
                    ...
                    controller: ['$scope', $scope => {
                        ...
                        $scope.userFilter = function(user) {
                            return (user._id !== $scope.checker.owner._id) && ($scope.checker.partners.findIndex(function(partner) { return partner === user._id; }) <0);
                        };
                        $scope.partnerFilter = function(user) {
                            return $scope.checker.partners.findIndex(function(partner) { return partner === user._id; }) >=0;
                        };
        ...
        $scope.taskFunc = {
            ...
            taskAuth : function(checker){
                var not_partner = checker.partners.findIndex(function(partner) { return partner === $scope.user._id; }) < 0,
